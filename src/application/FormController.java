...
public class FormController extends FormView {
	...
	//======================Album table methods (first TAB)==============================//
			...
			public void setCellsAlbumTable(){
			...
			public void loadDataFromDatabaseAlbums(){
				try {
			...
			public void setValueToAlbumTextFields(){
			...
			public void setCellsEmployeeTable(){
			...
			public void loadDataFromDatabaseEmployees(){
				try {
			...
			public void setValueToEmployeesTextFields(){
			...
			public void onAction (){
				buttonUpdate.setOnAction(e -> {udateAlbumTable ();});
				buttonDelete.setOnAction(e -> {removeFromAlbumTable ();});
				buttonAdd.setOnAction(e -> {addToAlbumTable ();});

				buttonUpdateEmployees.setOnAction(e -> {udateEmployeesTable ();});
				buttonDeleteEmployees.setOnAction(e -> {removeFromEmpployeesTable ();});
				buttonAddEmployees.setOnAction(e -> {addToEmployeesTable ();});
				
				exitMenuItem.setOnAction(e -> {exitProgram ();});
				hideFormMenuItem.setOnAction(e -> {hideForm ();});
				showFormMenuItem.setOnAction(e -> {showForm ();});
				enableFormMenuItem.setOnAction(e -> {makeEditableFields ();});
				disableFormMenuItem.setOnAction(e -> {makeNonEditableFields ();});
			}
}
